...
class lazamientos{
    ...
    public function obtener_lanzamiento_plataforma($plataforma){
        $sentencia_obtener_lanzamiento_plataforma="SELECT series.id,series.nombre,series.foto,lanzamientos.fecha
                                                   FROM lanzamientos,series
                                                   WHERE lanzamientos.serie=series.id
                                                   AND lanzamientos.plataforma = ?";

        $consulta=$this->bd->prepare($sentencia_obtener_lanzamiento_plataforma);
